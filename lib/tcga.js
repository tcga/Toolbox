...
(function (exports) {
    ...
    var loadScript, httpRequest, get, getJSON, getXML, getRange, data, hub, registerTab, toast, version;
 ...
 // The hub is a namespace of its own to communicate with our AG instance.
    exports.hub = (function () {
        ...
        baseURI = "http://agalpha.mathbiol.org:10035/repositories/tcga/custom/cors?query=";
        ...
        return {
            query: function (query, callback) {
                ...
                getJSON(baseURI + encodeURIComponent(query), callback);
            }
        };
    }());
