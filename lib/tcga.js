...
(function (exports) {
    ...
    var modules, loadScript, httpRequest, get, getJSON, getXML, getArchive, getRange, data, hub,
        registerTab, toast, version, updateLocation, updateModuleList;
                ...
                if (options.registerModules === true) {
                    loadedScripts.forEach(function (script) {
                     // Add modules to URL bar.
                        updateLocation(script);
                     // Add modules to list of loaded modules.
                        updateModuleList(script);
                    });
                }
 ...
 // @param {boolean} options.switchTab If true, immediately switch to newly created tab.
    ...
    updateLocation = function (module) {
    ...
    updateModuleList = function (module) {
        var list;
        list = $("#loaded-modules ul");
        list.append(
            $("<li></li>").append(
