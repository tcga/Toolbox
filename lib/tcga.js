...
(function (exports) {
    ...
    var modules, loadScript, get, find, data, ui, version, print;
 ...
 // @param {string} callback.body
    ...
    get.barcodes = function (uuids, callback) {
        ...
        $.ajax("https://tcga-data.nci.nih.gov/uuid/uuidws/mapping/json/uuid/batch", {
            type: "POST",
            data: uuids.join(","),
            headers: {
    ...
    get.uuids = function (barcodes, callback) {
        ...
        $.ajax("https://tcga-data.nci.nih.gov/uuid/uuidws/mapping/json/barcode/batch", {
            type: "POST",
            data: barcodes.join(","),
            headers: {
                "Content-Type": "text/plain"
