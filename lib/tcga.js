...
(function (exports) {
    ...
    var modules, loadScript, get, getJSON, getXML, getArchive, getRange,
        find, data, registerTab, toast, version;
 ...
 // Location of the TCGA file index.
 ...
 // @param {object} callback.res SPARQL query results in the SPARQL 1.1 Query Results JSON Format.
    exports.find = find = function (query, callback) {
        ...
        grapin.request({
            uri: endpoint + encodeURIComponent(query),
            headers: {
