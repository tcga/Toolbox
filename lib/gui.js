...
$(document).ready(function () {
 ...
 // The manifest module loader.
    (function (el) {
        ...
        TCGA.get.sparql("http://agalpha.mathbiol.org/repositories/manifest?query=" + encodeURIComponent(query), function (err, res) {
            var authors;
         ...
         // Add manifests to list.
            res.results.bindings.map(function (manifest) {
                $(authors).append(
 ...
 // List of registered modules.
    ...
    shareUrl = (function (el) {
        ...
        return {
            update: function () {
                input.val("http://tcga.github.io/web-toolbox/" + window.location.search);
            }
        };
